    ...
    return (
        <>
            <Stack>
                ...
                <Stack.Screen name="flowerpage" options={{
                    headerTitle: 'Flower information',
                    headerStyle: {backgroundColor: theme.background},
                    headerTitleStyle: {color: theme.text},
                    headerTintColor: theme.tint
                }}/>
                <Stack.Screen name="flowertemplate" options={{
                    headerTitle: 'Select your flower template',
                    headerStyle: {backgroundColor: theme.background},
                    headerTitleStyle: {color: theme.text},
                    headerTintColor: theme.tint
                }}/>
                <Stack.Screen name="createtemplate" options={{
                    headerTitle: 'Create your flower template',
                    headerStyle: {backgroundColor: theme.background},
                    headerTitleStyle: {color: theme.text},
                    headerTintColor: theme.tint
                }}/>
